...
on
( NAME = CINE_dat,
FILENAME = 'C:\Users\Friki\Documents\UTN\Cuatri 3\A ENTREGAR (el orto)\Proyecto - Cine\CINE.mdf' )
GO
...
-------------------------------------------------------------------------
/*Cuando el chabon de a "Confirmar compra" lo primero que hacemos es ejecutar el "NuevaFactura".
Despues, ActualizarButacas con estado en 0. 

Cada vez que hay una nueva factura, el cod_detalle_Factura se resetea porque es identity
Y a medida que se inserta un cod_Detalle_Factura se suma el precio al total a la que tenga cod_factura identico al insertado en cod_factura en detalle_factura.

Como sabemos ese codigoñ Porque el trigger checkea en que valor esta el identity actual, por ende, siempre le manda ese valor como codigo, que no va a cambiar hasta que no hagan click en la pagina en "Confirmar Compra"*/
